...
Forked from https://github.com/felizvida/pubmed and hosted at [katalepsara.com/PhD_Dashboard](https://katalepsara.com/PhD_Dashboard/).
...
3. Generates:
   * respective `YYYY-MM-DD/` folder
     * `digest.md`
     * `digest.json`
4. Publishes outputs to my [website dashboard](www.katalepsara.com/PhD_Dashboard)
